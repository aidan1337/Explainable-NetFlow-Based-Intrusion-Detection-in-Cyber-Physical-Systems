...
classifier = DecisionTreeClassifier(criterion='gini', splitter='best', max_depth=8, min_samples_split=15, min_samples_leaf=10)
...
#classifier = GridSearchCV(param_grid=params, estimator=DecisionTreeClassifier(random_state=10),return_train_score=True, cv=10)
